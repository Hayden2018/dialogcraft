...
const TitleContainer = styled('div')<ContainerProps>(({ isCurrent, theme: { palette, breakpoints } }) => ({
  width: 'calc(100% - 20px)',
  margin: '7px auto',
...
const EditButton = styled(EditIcon)(({ theme: { palette } }) => ({
  display: 'none',
  width: 20,
  height: 20,
...
const DeleteButton = styled(DeleteIcon)(({ theme: { palette } }) => ({
  display: 'none',
  width: 20,
  height: 20,
  margin: '3px 0px 0px 10px',
