...
const FormHeader = styled('div')(({ theme: { palette, breakpoints } }) => ({
      ...
      <Form onSubmit={handleSubmit(onSubmit)}>
        ...
        <FormRow>
          <Alert severity="info">
            <InfoList>
              <li>
                Temperature - higher values will make the output more random, and lower values more
                deterministic.
              </li>
        ...
        <FormRow>
          ...
          >
            {currentSettings.availableModels.map((modelId, index) => (
              <MenuItem key={index} value={modelId}>
                {modelId}
              </MenuItem>
            ))}
          </Select>
        ...
        <FormRow>
          <TextField label="System Prompt" fullWidth multiline rows={3} {...register('systemPrompt')} />
        </FormRow>
        <FormRow narrow>
          <SliderTop>
