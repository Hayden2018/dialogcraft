...
const SuccessIcon = styled(TickIcon)(({ theme }) => ({
  display: 'block',
  height: 150,
  width: 150,
  margin: '10px auto',
  ...
  if (importStatus === 'success')
    return (
      <Container>
        ...
        <SuccessIcon />
        <SuccessMessage>
          Chats import successful. Note that chats are arranged in time order with older imported chats
  ...
  return (
    <Container>
      ...
      <ButtonRow>
        ...
        <ImportButton
          color={importMode === 'merge' ? 'info' : 'warning'}
          variant="contained"
          onClick={importJSON}
        >
